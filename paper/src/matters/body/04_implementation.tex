...
\subsubsection{Modular Architecture and Technology Stack}
The pipeline couples five sequential modules: spatial ingestion, hazard overlay analysis, utility dependency mapping, temporal simulation, and scenario evaluation.
...
Naively intersecting road edges with flood polygons across $1{,}344$ hourly tier evaluations is computationally intractable.
...
The dataset (\texttt{HQ\_raw}) comprises $29$ discrete gauge shapefiles (\texttt{Pegel\_09\_00m} to \texttt{Pegel\_11\_80m}), spanning gauge heights from $9.00\,\text{m}$ to $11.80\,\text{m}$ (HQ100 peak) in $0.10\,\text{m}$ increments.
