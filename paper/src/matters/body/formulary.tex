...
Die Erweiterung des RoA-Indexes um die funktionalen Komponenten (Wasser, Strom, etc.) orientiert sich an dem MNSI-Konzept von Kaub et. al., wobei wir die bestehenden physischen Komponenten um funktionale Komponenten erweitern und dann alle Komponenten arithmetisch mitteln.
